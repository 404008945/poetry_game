        ...
        <div class="col-md-6">
            ...
            <form action="/register" class="fh5co-form animate-box" data-animate-effect="fadeInLeft" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <div class="alert alert-success" role="alert">请输入信息以完成快速注册</div>
                </div>
                <div class="form-group">
                    <label for="account" style="color: #000000;font-size:20px; " >手机号</label>
                    <input type="text" value="${users.account}" name="account" required="required" class="form-control" id="account" placeholder="请输入手机号" autocomplete="off">
                </div>
                <div class="form-group">
                    <label for="name" style="color: #000000;font-size:20px; ">短信验证码</label>
                    <input type="text" value="${users.username}" name="username" required="required"  class="form-control" id="name" placeholder="请留意您的手机验证码" autocomplete="off">
                </div>
                <div class="form-group">
                    ...
                    <p style="color: #e14b7e">下次将直接使用您的手机号和该密码进行登录</p>
                </div>
                <div class="form-group">
