...
<div id="page">
        ...
        <div class="container">
            <div class="row animate-box">
                <div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
                    <p style="font-size: 30px;color:#000000">${title}</p>
                    <p>${content}</p>
                </div>
            </div>
            <c:if test="${poetrySquareDtos.size()!=0}">
            <div class="row">
                        ...
                        <div class="fh5co-portfolio animate-box">
                            <a href="/user/poetryDetail/${dto.userPoetry.id}" style="border-radius: 15px">
                                <div class="portfolio-entry"
                                     style="background: url('/images/${dto.colors}.jpg') no-repeat;border-radius: 15px">
                                ...
                                <div class="portfolio-text">
                                    ...
                                    <h4 style="text-align:center;"><fmt:formatDate value="${dto.userPoetry.time}"
                                                                                   pattern="yyyy年MM月dd日 HH:mm:ss"/></h4>
                                </div>
                                <div style="text-align: center;margin-bottom: 20px">
                                    <span style="padding-right: 130px"><i
                                            class="icon-heart2"></i>${dto.userPoetry.likes}</span>
    ...
    <c:if test="${poetrySquareDtos.size()==0}">
        <div style="text-align: center;">
            <img src="/images/empty.jpg" style="width: 300px;">
        </div>
        <p style="font-size: 25px;text-align: center;color: #e14b7e">空空如也，主人还没有发表作品哦~</p>
    </c:if>
    <c:if test="${poetrySquareDtos.size()!=0}">
        <div class="center">
            <ul class="pagination">
                ...
                <c:if test="${pageInfo.pageNum==1}">
                    <li><a style="pointer-events: none;cursor:default;"
                           href="/user/poetry/${userId}/${pageInfo.prePage}">前一页</a></li>
                </c:if>
                <c:if test="${pageInfo.pageNum!=1}">
                ...
                <c:if test="${pageInfo.pageNum==pageInfo.pages}">
                    <li><a style="pointer-events:none;cursor:default;"
                           href="/user/poetry/${userId}/${pageInfo.nextPage}">下一页</a></li>
                </c:if>
                <c:if test="${pageInfo.pageNum!=pageInfo.pages}">
